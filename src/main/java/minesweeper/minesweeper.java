...
public class minesweeper extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<a href=\"?game=new&path=mines\">New Game</a><br>");
		session.setAttribute("hra", "open");
...

		{
			for (int column = 0; column < field.getColumnCount(); column++) {
				...
				out.print("<a href=\"?row=" + row + "&column=" + column + "&path=mines&hra=" + req.getParameter("hra")
						+ "\"><img src=\"resources/minesweeper/");
		...
		{
			out.println("<a href=\"?hra=open&path=mines\">Change to Open</a><br>");
		} else

		{
			out.println("<a href=\"?hra=mark&path=mines\">Change to Mark</a><br>");
		}
		out.println("</center>");
		out.println("</body>");
		out.println("</html>");
